...
import { ROLES, setStoredRole } from "../utils/roles.js";
    ...
    <main className="mx-auto w-full max-w-lg px-6 py-16">
      <div className="glass rounded-3xl p-8">
        ...
        <p className="mt-2 text-sm text-slate-300">
          {supabase
            ? "Sign in with your Supabase credentials to access role-based permissions."
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-neo-blue px-4 py-3 text-xs uppercase tracking-[0.3em] text-neo-black disabled:opacity-60"
          >
